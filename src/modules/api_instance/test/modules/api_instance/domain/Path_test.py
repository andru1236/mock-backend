...
route_with_delete = lambda: Route('/users', 'delete', Response({'test_delete': 'test_delete'}))
...
resource_delete = lambda: Resource(route_with_delete().method, route_with_delete().response)
